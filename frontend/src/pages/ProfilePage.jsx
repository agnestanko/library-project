...
function ProfilePage() {
  ...
  const myBooks = books.filter(b => b.createdBy?._id === user.id || b.createdBy === user.id);
      ...
      <div className="glass fade-up" style={{ padding: "36px 40px", marginBottom: 28 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 24, marginBottom: 28 }}>
          ...
          <div style={{
            ...
            fontSize: 32, fontWeight: 700, color: "#0d0d0f",
            flexShrink: 0,
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, marginTop: 24 }}>
          {[
            ...
            <div key={label} style={{
              ...
              <div style={{ fontSize: 22, fontWeight: 600, fontFamily: "'Playfair Display', serif", color: "var(--gold-light)" }}>
                {value}
              </div>
              <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 4, textTransform: "uppercase", letterSpacing: "0.06em" }}>
                {label}
              </div>
            </div>
          ))}
