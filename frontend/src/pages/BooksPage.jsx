...
function BooksPage() {
  ...
  useEffect(() => {
  if (searchParams.get("openAddBook") === "true") {
    setShowForm(true);
    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px" }}>
      ...
      {showForm && (
        ...
        >
          ...
          <form  ref={addBookFormRef} onSubmit={handleAddBook} style={{ display: "grid", gap: 14 }}>
            <div
              style={{
                display: "grid",
      ...
      <p
        className="fade-up-2"
        style={{ margin: "0 0 20px", fontSize: 13, color: "var(--muted)" }}
      >
        ...
        >
          {filteredBooks.map((book, i) => (
            <div
              key={book._id}
              className="fade-up"
              style={{ animationDelay: `${i * 0.05}s`, display: "flex" }}
            >
              <BookCard book={book} />
            </div>
          ))}
